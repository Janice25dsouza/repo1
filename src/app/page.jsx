...
const Page = () => {
  return (
    <div className="bg-black w-screen h-screen p-20 pt-10">
      ...
      <p className="mt-10 text-2xl text-white font-bold p-10 flex justify-center border-2 rounded-xl bg-black hover:bg-green-200 hover:text-black hover:border-black font-extralight hover:font-bold text-center">Hello!!! I&apos;m Janice. I enjoy art and reading. Art serves as my creative outlet. I also enjoy trying out new dishes and conversing with people.
      </p>
      
      <div className="hover:bg-yellow-500 rounded-2xl">
          <div className="text-center mt-48 pb-0 mb-0 hover:text-black ">
              <LightbulbIcon style={{ fontSize: 48, color: 'white' }} />
          </div>  

          <p className="font-black text-black p-10 text-2xl  pt-0 flex justify-center text-center">Feedback: The session was quite useful. The hands-on approach with coding exercises was helpful. The instructions were easy to understand and quite simple to follow.
          </p>
      </div>
